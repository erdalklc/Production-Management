...
namespace EPM.Plan.Api.Controllers
{
    ...
    public class PlanController : ControllerBase
    {
        ...
        [ HttpPost]
        public ActionResult<object> GetPlan(object[] obj)=>_planService.GetPlan(obj[0].ToStringParse(),obj[1].IntParse(), obj[2].ToString(), obj[3].ToStringParse(), obj[4].ToStringParse(), obj[5].IntParse(), obj[6].IntParse(), obj[7].IntParse(), obj[8].IntParse(), obj[9].ToString());
        public ActionResult<object> GetPlanBandGiris(object[] obj)=>_planService.GetPlanBandGiris(obj[0].ToStringParse(),obj[1].IntParse(), obj[2].ToString(), obj[3].ToStringParse(), obj[4].ToStringParse(), obj[5].IntParse(), obj[6].IntParse(), obj[7].IntParse(), obj[8].IntParse(), obj[9].ToString());
