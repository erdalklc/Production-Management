#pragma checksum "E:\Eren\Eren Production Management\EPM.Fason.Web\Views\Fason\_PartialSiparisListesiDetail.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "00bc771d43bae81f7606df7b77efb51a4b074aee"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"00bc771d43bae81f7606df7b77efb51a4b074aee", @"/Views/Fason/_PartialSiparisListesiDetail.cshtml")]
...
#nullable restore
#line 6 "E:\Eren\Eren Production Management\EPM.Fason.Web\Views\Fason\_PartialSiparisListesiDetail.cshtml"
Write(Html.DevExtreme().DataGrid<EPM.Fason.Dto.Fason.SIPARIS_LISTESI_DETAIL> ().ID("edgridDetail")
    ...
    .Columns(columns => { 
        ...
        columns.AddFor(m => m.ENTEGRATION_ID).Visible(false).AllowEditing(false).AllowExporting(true);
        columns.AddFor(m => m.ENTEGRATION_HEADER_ID).Visible(false).AllowEditing(false).AllowExporting(true); 
...
#nullable restore
#line 39 "E:\Eren\Eren Production Management\EPM.Fason.Web\Views\Fason\_PartialSiparisListesiDetail.cshtml"
                                                       Write(Model);
