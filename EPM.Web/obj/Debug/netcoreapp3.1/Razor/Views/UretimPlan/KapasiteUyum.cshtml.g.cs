#pragma checksum "E:\Eren\Eren Production Management\EPM.Web\Views\UretimPlan\KapasiteUyum.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7941e4d8c62bbe978ba53c58eb03a53f1d4a17b3"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7941e4d8c62bbe978ba53c58eb03a53f1d4a17b3", @"/Views/UretimPlan/KapasiteUyum.cshtml")]
...
#nullable restore
#line 4 "E:\Eren\Eren Production Management\EPM.Web\Views\UretimPlan\KapasiteUyum.cshtml"
...
<script>
    ...
    function Chart_Clicked(WEEK_VALUE) {
        ...
        $.ajax({
            ...
            url: '");
#nullable restore
#line 27 "E:\Eren\Eren Production Management\EPM.Web\Views\UretimPlan\KapasiteUyum.cshtml"
...
#nullable disable
            ...
            WriteLiteral(@"(""#edReport"").dxDataGrid({
                    ...
                    editing: {
                        ...
                        for");
            WriteLiteral(@" (var i = 0; i < YEARS.length; i++) {
                            columns.push({
           ...
           ");
            WriteLiteral(@"                     else if (columns[a].dataField == ""DEADLINE"" ||columns[a].dataField == ""SHIPMENT_DATE"") {
                                    columns[a].width = 100;
                        ...
                        ");
            WriteLiteral(@"                        top += rowData[COLUMNNAMES[m].NAME];
                                        }
            ...
            WriteLiteral(@"{
                        ...
                        var settings = {
                            ...
                            ""url"": """);
#nullable restore
#line 151 "E:\Eren\Eren Production Management\EPM.Web\Views\UretimPlan\KapasiteUyum.cshtml"
