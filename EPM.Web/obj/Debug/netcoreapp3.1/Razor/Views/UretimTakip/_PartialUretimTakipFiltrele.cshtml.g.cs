#pragma checksum "D:\GitProjects\Eren-Production-Management\EPM.Web\Views\UretimTakip\_PartialUretimTakipFiltrele.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a51e14f6076de3ad78a10e187603f8eca287ac4f"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a51e14f6076de3ad78a10e187603f8eca287ac4f", @"/Views/UretimTakip/_PartialUretimTakipFiltrele.cshtml")]
    ...
    public class Views_UretimTakip__PartialUretimTakipFiltrele : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<EPM.Track.Dto.Track.TrackList_Filter>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            WriteLiteral("\r\n\r\n\r\n");
#nullable restore
#line 6 "D:\GitProjects\Eren-Production-Management\EPM.Web\Views\UretimTakip\_PartialUretimTakipFiltrele.cshtml"
...
#nullable restore
#line 11 "D:\GitProjects\Eren-Production-Management\EPM.Web\Views\UretimTakip\_PartialUretimTakipFiltrele.cshtml"
Write(Html.DevExtreme().DataGrid<EPM.Track.Dto.Track.UretimTakipListesi>().ID("edUretimTakipGrid")
    ...
    PopWriter();
            ...
            if (Model.PRODUCTION_TYPE == 1)
            {
                t.AddFor(ob => ob.KESIM_ADET).SummaryType(SummaryType.Sum).CustomizeText(item => new global::Microsoft.AspNetCore.Mvc.Razor.HelperResult(async(__razor_template_writer) => {
    PushWriter(__razor_template_writer);
    WriteLiteral("function(data){return data.value}");
    PopWriter();
}
));
                t.AddFor(ob => ob.TASNIF_ADET).SummaryType(SummaryType.Sum).CustomizeText(item => new global::Microsoft.AspNetCore.Mvc.Razor.HelperResult(async(__razor_template_writer) => {
    PushWriter(__razor_template_writer);
    WriteLiteral("function(data){return data.value}");
    PopWriter();
}
));
                t.AddFor(ob => ob.BANT_ADET).SummaryType(SummaryType.Sum).CustomizeText(item => new global::Microsoft.AspNetCore.Mvc.Razor.HelperResult(async(__razor_template_writer) => {
    PushWriter(__razor_template_writer);
    WriteLiteral("function(data){return data.value}");
    PopWriter();
}
));
                t.AddFor(ob => ob.KALITE_ADET).SummaryType(SummaryType.Sum).CustomizeText(item => new global::Microsoft.AspNetCore.Mvc.Razor.HelperResult(async(__razor_template_writer) => {
    PushWriter(__razor_template_writer);
    WriteLiteral("function(data){return data.value}");
    PopWriter();
}
