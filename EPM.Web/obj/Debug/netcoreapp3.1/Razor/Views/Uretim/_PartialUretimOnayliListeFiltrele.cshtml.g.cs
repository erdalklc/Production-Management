#pragma checksum "D:\Projects\Eren Production Management\EPM.Web\Views\Uretim\_PartialUretimOnayliListeFiltrele.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4320331b4588af867263db90d9a9238349ad228e"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4320331b4588af867263db90d9a9238349ad228e", @"/Views/Uretim/_PartialUretimOnayliListeFiltrele.cshtml")]
    ...
    public class Views_Uretim__PartialUretimOnayliListeFiltrele : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<EPM.Core.FormModels.Uretim.UretimOnayliListe>
    {
...
#nullable restore
#line 10 "D:\Projects\Eren Production Management\EPM.Web\Views\Uretim\_PartialUretimOnayliListeFiltrele.cshtml"
Write(Html.DevExtreme().DataGrid<EPM.Core.FormModels.Uretim.MasterList> ().ID("edgridHeader")
    .ShowBorders(false)
    .DataSource(
        ob=>ob.Mvc().Controller("Uretim")
        .LoadParams(Model)
        .LoadAction("UretimOnaylilLoad")
    ...
    //.Sorting(ob=>ob.Mode(GridSortingMode.None))
    .ColumnAutoWidth(true)
    .ShowBorders(true)
    .Paging(ob=>ob.PageSize(50).Enabled(true)) 
    .Editing(ob => ob.Mode(GridEditMode.Cell).AllowUpdating(editable).AllowDeleting(editable).AllowAdding(editable).StartEditAction(GridStartEditAction.DblClick))
    ...
    .Columns(columns =>
    {
        ...
        columns.AddFor(m => m.EXPECTED_COST).Visible(false);
        columns.AddFor(m => m.CURRENCY_UNIT).Width(80).Lookup(look => look.DataSource(d => d.Mvc().Controller("Uretim").LoadAction("GetCurrencyUnits").Key("ID")).DisplayExpr("CURRENCY_UNIT").ValueExpr("ID")).Visible(false);
