#pragma checksum "D:\Projects\Eren Production Management\EPM.Web\Views\Uretim\_PartialUretimOnayliListeFiltrele.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e75179171c271b4a5992fcabed2fe61c518c1a5c"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e75179171c271b4a5992fcabed2fe61c518c1a5c", @"/Views/Uretim/_PartialUretimOnayliListeFiltrele.cshtml")]
    ...
    public class Views_Uretim__PartialUretimOnayliListeFiltrele : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<List<EPM.Production.Dto.Production.MasterList>>
    {
...
Write(Html.DevExtreme().DataGrid<EPM.Production.Dto.Production.MasterList>().ID("edgridHeader")
    ...
    .Columns(columns =>
    {
        ...
        columns.AddFor(m => m.APPROVAL_STATUS).Width(110).Lookup(look => look.DataSource(d => d.Mvc().Controller("Uretim").LoadAction("GetApprovalStatusList").Key("ID")).DisplayExpr("ADI").ValueExpr("ID"));
...
#nullable disable
        ...
        [global::Microsoft.AspNetCore.Mvc.Razor.Internal.RazorInjectAttribute]
        public global::Microsoft.AspNetCore.Mvc.Rendering.IHtmlHelper<List<EPM.Production.Dto.Production.MasterList>> Html { get; private set; }
    }
}
