#pragma checksum "D:\GitProjects\Eren-Production-Management\EPM.Web\Views\Uretim\UretimListesiDegisiklik.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "1c0c7c9c9cbcdb3d34109b4311bd12b4556ffd54"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(EPM_Web.Models.Uretim.Views_Uretim_UretimListesiDegisiklik), @"mvc.1.0.view", @"/Views/Uretim/UretimListesiDegisiklik.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"1c0c7c9c9cbcdb3d34109b4311bd12b4556ffd54", @"/Views/Uretim/UretimListesiDegisiklik.cshtml")]
    ...
    public class Views_Uretim_UretimListesiDegisiklik : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<EPM.Production.Dto.Production.UretimOnayliListe>
    {
...
#nullable restore
#line 8 "D:\GitProjects\Eren-Production-Management\EPM.Web\Views\Uretim\UretimListesiDegisiklik.cshtml"
            ...
            items.AddGroup().ColCount(7).Items(groupItems =>
            {
                ...
                groupItems.AddButton().HorizontalAlignment(HorizontalAlignment.Left).VerticalAlignment(VerticalAlignment.Center)
                   .ButtonOptions(b => b.Text("FİLTRELE")
                       ...
                       .Width("100%")
                       .OnClick("UretimListesiDegisiklikFiltrele")
...
<script>
     function UretimListesiDegisiklikFiltrele() {
        $(""#edReportDetail"").html("""");
        var data = {
        ...
        $.ajax({
            ...
            url: '");
#nullable restore
#line 75 "D:\GitProjects\Eren-Production-Management\EPM.Web\Views\Uretim\UretimListesiDegisiklik.cshtml"
             Write(Url.Action("_PartialUretimliListeDegisiklikFiltrele", "Uretim"));
      ...
      function exportingDikeyListe(e) {
        ...
        DevExpress.excelExporter.exportDataGrid({
            ...
            workbook.xlsx.writeBuffer().then(function (buffer) {
                saveAs(new Blob([buffer], { type: 'application/octet-stream' }), 'EPM_PRODUCTION_CHANGES.xlsx');
            });
        });
        e.cancel = true;
    }
