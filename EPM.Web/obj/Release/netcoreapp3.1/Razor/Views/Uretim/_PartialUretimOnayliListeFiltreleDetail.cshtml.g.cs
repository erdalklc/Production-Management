#pragma checksum "D:\Projects\Eren Production Management\EPM.Web\Views\Uretim\_PartialUretimOnayliListeFiltreleDetail.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "986a1f2311fb59d1cf5956563eed9cd5196c4a76"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"986a1f2311fb59d1cf5956563eed9cd5196c4a76", @"/Views/Uretim/_PartialUretimOnayliListeFiltreleDetail.cshtml")]
    ...
    public class Views_Uretim__PartialUretimOnayliListeFiltreleDetail : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<int>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral("\r\n");
#nullable restore
#line 4 "D:\Projects\Eren Production Management\EPM.Web\Views\Uretim\_PartialUretimOnayliListeFiltreleDetail.cshtml"
...
#nullable restore
#line 8 "D:\Projects\Eren Production Management\EPM.Web\Views\Uretim\_PartialUretimOnayliListeFiltreleDetail.cshtml"
Write(Html.DevExtreme().DataGrid<EPM.Core.FormModels.Uretim.DetailList> ().ID("edgridDetail")
    .ShowBorders(false)
    ...
    PopWriter();
        ...
        items.AddFor(m => m.EXPECTED_COST).Alignment(HorizontalAlignment.Right).SummaryType(SummaryType.Avg).CustomizeText(item => new global::Microsoft.AspNetCore.Mvc.Razor.HelperResult(async(__razor_template_writer) => {
    PushWriter(__razor_template_writer);
    WriteLiteral("function(data){return \"ORT:\" +data.value}");
    PopWriter();
}
));
        items.AddFor(m => m.REALESED_COST).Alignment(HorizontalAlignment.Right).SummaryType(SummaryType.Avg).CustomizeText(item => new global::Microsoft.AspNetCore.Mvc.Razor.HelperResult(async(__razor_template_writer) => {
    PushWriter(__razor_template_writer);
    WriteLiteral("function(data){return \"ORT:\" +data.value}");
    PopWriter();
}
    ...
    .Columns(columns => {
        ...
        columns.Add().Width(50).Type(GridCommandColumnType.Buttons).Buttons(btn => btn.Add().Icon("fa fa-history").OnClick("LogSearchDetail"));
...
#nullable restore
#line 47 "D:\Projects\Eren Production Management\EPM.Web\Views\Uretim\_PartialUretimOnayliListeFiltreleDetail.cshtml"
                                                                             Write(Model);
...
#nullable disable
    ...
    PopWriter();
        ...
        columns.AddFor(m => m.EXPECTED_COST).Visible(true);
        columns.AddFor(m => m.REALESED_COST).Visible(true);
        columns.AddFor(m => m.CURRENCY_UNIT).Width(80).Lookup(look => look.DataSource(d => d.Mvc().Controller("Uretim").LoadAction("GetCurrencyUnits").Key("ID")).DisplayExpr("CURRENCY_UNIT").ValueExpr("ID")).Visible(true);
...
#nullable restore
#line 54 "D:\Projects\Eren Production Management\EPM.Web\Views\Uretim\_PartialUretimOnayliListeFiltreleDetail.cshtml"
                                                       Write(Model);
