...
namespace EPM.Core.Helpers
{
    ...
    {
        public static string KesimFoyleri(int ITEM_NUMBER, int PO_HEADER_ID,string MAMUL_RENGI,string ANAMODEL)
        { 
...
", ITEM_NUMBER,PO_HEADER_ID,MAMUL_RENGI, ANAMODEL + ".X.X");
        ...
        public static string KesimFoyleri2(int ITEM_NUMBER, int PO_HEADER_ID, string MAMUL_RENGI, string ANAMODEL)
        { 
            string sql = string.Format(@"
                            SELECT 
                              WE.WIP_ENTITY_NAME
...
", MAMUL_RENGI, ANAMODEL + ".X.X");
        ...
        public static string KesimFoyleri3(string KesimFoyu)
        {
            string sql = string.Format(@"
                            SELECT 
                              WE.WIP_ENTITY_NAME
