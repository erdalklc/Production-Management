...
ORDER BY creation_date ASC",ORGANIZATION_ID);
            ...
            return OracleServer.DeserializeList<DepoBilgileri>(SQL);
        }
        ...
        public List<SaticiBilgileri> GetVendorList(int ORGANIZATION_ID = 105)
        {
            ...
            return OracleServer.DeserializeList<SaticiBilgileri>(SQL);
        }
...
ORDER BY 1
            ...
            string paraBirimi = OracleServer.ReadString(sql);
...
ORDER BY 1",paraBirimi);
            ...
            List<ParaBirimleri> birimler = OracleServer.DeserializeList<ParaBirimleri>(sql);
        ...
        int KalemItemId(string KALEM_KODU, int ORGANIZATION_ID)
        {
            ...
            return OracleServer.ReadInteger(sql);
        }
        ...
        bool KalemKategorisiVarmi(string KALEM_KODU,int ORGANIZATION_ID)
        {
            ...
            return OracleServer.ReadInteger(sql) > 0;
        }
        ...
        { 
            ...
            try
            {
                using (OracleConnection sqlConnection = new OracleConnection(OracleServer.connectionString))
                {
                    sqlConnection.Open();
